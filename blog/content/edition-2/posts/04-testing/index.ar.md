...
مثل [VGA text buffer][vga lazy-static]، نستخدم `spin::Lazy` و spinlock لإنشاء instance `static` writer. باستخدام `Lazy` نضمن أن UART تُهيَّأ مرة واحدة فقط عند أول استخدام.
