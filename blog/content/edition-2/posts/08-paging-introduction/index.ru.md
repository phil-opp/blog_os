...
Изменяя адрес памяти перед фактическим доступом, сегментация уже применяет технику, которую сегодня применяется практически повсеместно: _виртуальная память_.
...
Не существует способа отобразить третий экземпляр программы в виртуальную память без перекрытия, даже если свободно больше чем требуется памяти. Проблема в том, что нам нужна _непрерывния_ память, и мы не можем использовать небольшие свободные фрагменты.
...
## Пагинация на x86_64 {#paging-on-x86-64}
...
![Та же самая 4-уровневая иерархия страниц с 5 дополнительными стрелками: "Step 0" из регистра CR3 в таблицу 4-го уровня, "Step 1" из записи 4-го уровня в таблицу 3-го уровня, "Step 2" из записи 3-го уровня в таблицу 2-го уровня, "Step 3" из записи 2-го уровня в таблицу 1-го уровня и "Step 4" из таблицы 1-го уровня в отображенные кадры.](x86_64-page-table-translation-steps.svg)
...
### Формат Таблицы Страниц {#page-table-format}
...
["Минимально возможное ядро на Rust"]: @/edition-2/posts/02-minimal-rust-kernel/index.ru.md#creating-a-bootimage
